...
- **Screen mirroring**: Mirrors device screens through the bundled scrcpy binary in a separate scrcpy window, with per-device video, audio, window, control, device, and recording options plus a shortcut reference.
